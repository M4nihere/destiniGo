...
const steps = [
    ...
    { id: 5, title:"Receive offer letter",                description: "Accept the university offer, pay initial deposit and get Confirmation of Acceptance for Studies (CAS).", icon: <FaUserGraduate /> },
    ...
    { id: 7, title:"Plan accommodation & travel",         description: "Book housing, flight, and get ready to study in UK.", icon: <FaGlobe /> },
...
export default function StudyUKProcess() {
  ...
  return (
    <div className="bg-gray-100 min-h-[500px] py-10">
      <div className="max-w-5xl mx-auto text-center px-6">
        <h1 className="text-3xl font-bold text-blue-600 mb-6">Study in UK: Step-by-Step guide</h1>
        <p className="text-gray-700 mb-10">Follow these key steps to successfully apply for studying in UK.</p>
