...
const ImpactSection_usa = () => {
  const universities = [
    { name: 'Harvard University', image: '/images/countries/usa/colleges/harward.webp' },
    { name: 'NYU', image: '/images/countries/usa/colleges/nyu.webp' },
    { name: 'Purdue University', image: '/images/countries/usa/colleges/purdue.webp' },
    { name: 'Stanford University', image: '/images/countries/usa/colleges/standford.webp' },
    { name: 'ASU', image: '/images/countries/usa/colleges/arizona-state-university (asu).webp' },
    { name: 'UIUC', image: '/images/countries/usa/colleges/UIUC.webp' },
    { name: 'University of Wisconsin-Madison', image: '/images/countries/usa/colleges/wiscosin.webp' },
    { name: 'Yale University', image: '/images/countries/usa/colleges/yale.webp' }
  ];
...
export default ImpactSection_usa;
