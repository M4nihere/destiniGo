...
const ExamsInfo = () => {
  ...
  {/* <div className="absolute -top-6 right-10 w-10 h-10 opacity-20">
    <Image src="/images/exam/ielts.png" alt="Study Abroad" width={40} height={40} />
  </div>
  <div className="absolute -top-6 left-10 w-10 h-10 opacity-20">
    <Image src="/images/exam/ielts.png" alt="Global Education" width={40} height={40} />
  </div> */}
</div>
      ...
      <section className="mb-16">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 p-4">
            <Image src="/images/exam/ielts1.webp" alt="IELTS Exam" width={500} height={300} className="rounded-lg shadow-lg" />
          </div>
        </div>
    ...
    >
      ...
      <section>
        <div className="flex flex-col md:flex-row-reverse items-center">
          ...
          <div className="md:w-1/2 p-4">
            <Image src="/images/exam/pte.webp" alt="PTE Exam" width={500} height={300} className="rounded-lg shadow-lg" />
          </div>
        </div>
  ...
  <div className="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-10">
    ...
    <div className="md:w-1/2 bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-500">
      <h3 className="text-2xl font-semibold text-blue-600 mb-2 flex items-center">
        <Image src="/images/exam/check.webp" alt="Check" width={24} height={24} className="mr-2" />
        Who Can Apply?
      </h3>
    ...
    <div className="md:w-1/2 bg-white p-6 rounded-lg shadow-md border-l-4 border-cyan-500">
      <h3 className="text-2xl font-semibold text-cyan-600 mb-2 flex items-center">
        <Image src="/images/exam/calender.webp" alt="Calendar" width={24} height={24} className="mr-2" />
        Best Time to Apply
      </h3>
      <p className="text-gray-700 text-lg">
