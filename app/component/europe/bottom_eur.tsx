...
const steps = [
    ...
    { id: 7, title:"Plan accommodation & travel",         description: "Book housing, flight, and get ready to study in Europe.", icon: <FaGlobe /> },
    { id: 8, title:"Attend orientation",                  description: "Join orientation program and start your academic journey.", icon: <FaUserGraduate /> }
  ];

export default function StudyEuropeProcess() {
  ...
  return (
    <div className="bg-gray-100 min-h-[500px] py-10">
      <div className="max-w-5xl mx-auto text-center px-6">
        <h1 className="text-3xl font-bold text-blue-600 mb-6">Study in Europe: Step-by-Step guide</h1>
        <p className="text-gray-700 mb-10">Follow these key steps to successfully apply for studying in Europe.</p>
