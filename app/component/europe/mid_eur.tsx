    ...
    <section className="max-w-6xl mx-auto p-8">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 px-4 sm:px-6 md:px-12 lg:px-16">
            ...
            <div className="md:w-1/2">
              ...
              Europe is a premier destination for international education offering a distinguished 
              academic heritage, cutting-edge research opportunities and a diverse cultural environment. 
              Home to renowned universities in countries such as Germany, France, the NetherLands, and 
              Sweden. Europe provides high-quality education at relatively affordable tuition fees. 
              Many European nations offer scholarship programs and post-study work opportunities. With its multicultural setting, multilingual 
              advantages, and strong industry connections, Europe delivers an immersive and globally relevant 
              learning experience. Whether pursuing research-intensive programs, innovation-driven courses, 
              or a historically rich academic environment. Europe remains an excellent choice for students 
              aspiring to study abroad.
              </p>
            </div>
          </div>
    
          {/* Why Choose Europe Section - Creative Wave Pattern */}
          <div className="mt-16">
