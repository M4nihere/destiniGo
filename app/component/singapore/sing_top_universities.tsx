...
const ImpactSection_singapore = () => {

  const universities = [
    { name: 'James-Cook University', image: '/images/countries/singapore/colleges/james-cook.webp' },
    { name: 'Nanyang Technological University ', image: '/images/countries/singapore/colleges/nanyang.webp' },
    { name: 'National University of Singapore', image: '/images/countries/singapore/colleges/nus.webp' },
    { name: 'Singapore Institute of Technology', image: '/images/countries/singapore/colleges/sing_insti_tech.webp' },
    { name: 'SUTD', image: '/images/countries/singapore/colleges/sing_tech_design.webp' },
    { name: 'Singapore Management University', image: '/images/countries/singapore/colleges/smu.webp' },
  ];
...
export default ImpactSection_singapore;
