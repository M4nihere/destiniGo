...
useEffect(() => {
  ...
  <span className="flex items-center gap-1 translate-y-1"> {/* Shift down slightly */}
    <Image src="/images/logo/graduation_cap.png" alt="Crown" width={32} height={21} />
    Admitted
  </span>
</div>
  ...
  {uni.name}
                ...
                {/* Shortlisted Students (Bottom Left) */}
                {/* <div className="absolute bottom-2 left-2 bg-blue-600 text-white text-xs font-semibold px-3 py-1 rounded-md shadow-lg">
                  🎓 {uni.shortlisted} Shortlisted
                </div> */}

                {/* Scholarship Recipients (Bottom Right) */}
                {/* <div className="absolute bottom-2 right-2 bg-green-600 text-white text-xs font-semibold px-3 py-1 rounded-md shadow-lg">
                  💰 {uni.scholarshipRecipients} Scholarships
                </div> */}
              </div>
